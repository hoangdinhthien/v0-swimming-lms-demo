...
export default function NewCoursePage() {
  ...
  const updateLesson = (moduleIndex: number, lessonIndex: number, lesson: string) => {
    const newModules = [...modules]
    ...
    <DashboardLayout userRole="admin">
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Add a new swimming course to your catalog</p>
        </div>
      </div>
      ...
      <div className="grid gap-6 mt-8">
          ...
          <CardContent className="space-y-4">
            <div className="grid gap-4 md:grid-cols-2">
              <div className="space-y-2">
                ...
                <Input id="title" placeholder="e.g. Beginner Swimming" />
              </div>
              <div className="space-y-2">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="space-y-2">
                ...
                <Input id="age" placeholder="e.g. 5+ years" />
              </div>
              <div className="space-y-2">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="space-y-2">
                ...
                <Input id="sessions" placeholder="e.g. 2 sessions per week, 45 minutes each" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="price">Price</Label>
                <Input id="price" placeholder="e.g. $120" />
              </div>
            </div>
            <div className="space-y-2">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="space-y-2">
                ...
                <Input id="prerequisites" placeholder="e.g. None" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="equipment">Required Equipment</Label>
                <Input id="equipment" placeholder="e.g. Swimsuit, towel, goggles" />
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Define the modules and lessons for this course</CardDescription>
          </CardHeader>
