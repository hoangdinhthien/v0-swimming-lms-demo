      ...
      <div className='flex flex-col gap-4 md:flex-row md:items-center md:justify-between'>
        <div>
          ...
          <p className='text-muted-foreground'>
            Xem danh sách học viên được phân quyền tại trung tâm bơi lội
          </p>
        </div>
        {/* Staff typically don't have permission to add students, but keeping for consistency */}
                  ...
                  filteredStudents.map((student) => {
                    ...
                    return (
                      <TableRow
                        ...
                        onClick={() =>
                          router.push(`/dashboard/staff/students/${user._id}`)
                        }
                      >
